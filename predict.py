...
Usage: 
python predict.py flowers/test/1/image_07117.jpg checkpoint.pth --gpu
python predict.py flowers/test/10/image_07117.jpg checkpoint.pth --category_names cat_to_name.json --top_k 10
python predict.py flowers/test/10/image_07117.jpg checkpoint.pth --category_names cat_to_name.json --top_k 10 --gpu
"""
import numpy as np
import torch
...
def load_checkpoint(filepath):
    """Loads checkpoint amd returns model"""
